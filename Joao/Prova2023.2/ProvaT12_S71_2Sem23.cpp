...
namespace agentes
{
    class Agente // classe abstrata pois possui ao menos uma função virtual pura
    {
        protected:
            static int cont_id;
            int id;
    ...
    class Espiao : public Agente
    {
        ...
        public:
            ...
            void agir(); // a ser implementado depois da cria��o da classe Secreto dado a depend�ncia.
    ...
    void Espiao::agir()
    {
            ...
            while ( iterador != secres.end() )
            {
                if ( *iterador )
                {
                    ...
                    {
                        (*iterador)->operator--();
                        cout << "Diminuindo for�a de: " << *iterador << endl;
                    }
                    else
                    {
    ...
    public:
        ...
        void criarAgentes()
        {
            ...
            for (int i = 0; i < max; i++)
            {
                ...
                {
                    cout << "Agente secreto n�o alocado!" << endl;
                }
            }
                // ----------------------------------
            ...
            for (int i = 0; i < max; i++)
            {
                ...
                {
                    cout << "Agente espi�o n�o alocado!" << endl;
                }
            ...
            for (int i = 0; i < max; i++)
            {
                ...
                {
                    cout << "Agente duplo n�o alocado!" << endl;
                }
            }
